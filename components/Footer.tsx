        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="hover:text-brand-cyan transition-colors">Find DJs</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="hover:text-brand-cyan transition-colors">Join as DJ</a></li>
              <li><a href="#" className="hover:text-brand-cyan transition-colors">DJ Dashboard</a></li>
