...
import { StarIcon, VerifiedIcon, MapPinIcon, ChevronLeftIcon, LoaderIcon, MusicIcon, CalendarIcon } from './icons';
                ...
                <div className="bg-brand-surface rounded-xl shadow-lg p-6">
                  ...
                  <form className="space-y-4">
                    <div>
                      ...
                      <input type="date" className="w-full mt-1 bg-brand-dark text-white border border-gray-600 rounded-lg px-4 py-2 focus:ring-2 focus:ring-brand-cyan focus:outline-none" />
                    </div>
                     <div>
                      <label className="text-sm font-medium text-gray-300">Event Type</label>
                      <select className="w-full mt-1 bg-brand-dark text-white border border-gray-600 rounded-lg px-4 py-2 focus:ring-2 focus:ring-brand-cyan focus:outline-none appearance-none">
